...
ENV INSTAGRAM_SCOPES=instagram_business_basic,instagram_business_content_publish
ENV INSTAGRAM_GRAPH_BASE_URL=https://graph.instagram.com/v24.0
ENV INSTAGRAM_PROCESSING_ATTEMPTS=30
ENV INSTAGRAM_PROCESSING_DELAY_MS=10000
